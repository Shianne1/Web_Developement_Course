...
<body class = "w3-pale-red">
    ...
    <div class="w3-container w3-light-gray">
        <?php 
        if($quantity <= 0){
            echo "You did not order anythign on the previous page!";
            echo "Please go back and try again <br>"
            exit;
        }
        
        echo "Order processed at $date<br>";
        echo "Your order is a follows: <br>";
        ...
        @$fp = fopen("orders.text", "ab");
               if(!$fp){
                echo "<br>Your order cannot be proccessed at this time. Please try again later<br>";
                exit;
               }
